          ...
          <div className="relative flex w-80 flex-col rounded-xl bg-[#43639c] bg-clip-border text-white shadow-md">
            ...
            <div className="p-6 pt-0">
              <button
                ...
                type="button"
                className="select-none font-spacegroteskmedium rounded-lg bg-blue-500 py-3 px-6 text-center align-middle text-xs uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
              >
                Read More
              </button>
            </div>
          ...
          <div className="relative flex w-80 flex-col rounded-xl bg-[#43639c] bg-clip-border text-white shadow-md">
            ...
            <div className="p-6 pt-0">
              <button
                data-ripple-light="true"
                type="button"
                className="select-none rounded-lg bg-blue-500 py-3 px-6 text-center align-middle font-spacegroteskmedium text-xs uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
              >
                Read More
              </button>
            </div>
          ...
          <div className="relative flex w-80 flex-col rounded-xl bg-[#43639c] bg-clip-border text-white shadow-md">
            ...
            <div className="p-6 pt-0">
              <button
                data-ripple-light="true"
                type="button"
                className="select-none rounded-lg bg-blue-500 py-3 px-6 text-center align-middle text-xs font-spacegroteskmedium uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
              >
                Read More
              </button>
            </div>
