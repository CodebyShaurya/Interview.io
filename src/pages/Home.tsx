...
function App() {
    return (
        <div className='bg-gradient-to-r from-[#2f1d64] via-[#1b2a5c] to-[#2f1d64] ...'>
            <Nav/>
            {/* <div className="bg-gradient-to-br from-[rgba(75,30,133,1)] to-[rgba(75,30,133,0.01)]">
                gjhgjhg
            </div> */}
            <div className='grid grid-cols-2 p-24'>
                <div className=''>
                    <div className='text-7xl font-semibold my-10 text-white'>Take Your <span className='text-sky-300'>Learning</span> <br/> To The Next Level.</div>
                    <div className='text-slate-300 my-10 mr-10'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration</div>
            ...
            <div className='mx-24'>
                <div className='mx-5 text-transparent bg-gradient-to-l from-blue-300 to-purple-600 bg-clip-text w-24 font-bold text-2xl'>Benefits</div>
                <div className='text-4xl font-bold m-5 text-white'>Great Deals for you</div>
                <div className='text-slate-300 m-5'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration</div>

                    {/* <div className="cube">
                        <div className="box box1">
                            <img
                            src="https://media.geeksforgeeks.org/wp-content/uploads/20210223233400/gfg4.jpg"
                            alt="image 1"
                            />
                        </div>
                        <div className="box box2">
                            <img
                            src="https://media.geeksforgeeks.org/wp-content/uploads/20210223232947/gfg2.jpg"
                            alt="image 2"
                            />
                        </div>
                        ...
                        <div className="box box5">
                            <img
                            src="https://media.geeksforgeeks.org/wp-content/uploads/20210223233046/gfg3.png"
                            alt="image 5"
                            />
                        </div>
                        <div className="box box6">
                            <img
                            src="https://media.geeksforgeeks.org/wp-content/uploads/20210223232853/gfg1.png"
                            alt="image 6"
                            />
                        </div>
                    </div> */}
                ...
                <div className='flex justify-center m-24'>
                    ...
                    {/* <div className="bg-indigo-700 w-80 p-5 h-60 shadow-md relative rounded-md">
                    <div className="py-3 px-1 text-white">
                        <svg
                        className="w-10 h-9"
                        stroke="currentColor"
                        strokeWidth="1.5"
                    ...
                    <p className="text-2xl font-bold text-white font-sans">Chem</p>
                    <div className="text-sm py-2 text-white font-mono">
                    ...
                    <p className="text-3xl text-white font-bold font-sans">Chem</p>
                    <div className="text-sm py-2 font-mono text-white">
                        branch of science that examines the compounds made of atoms, molecules, and
                        the properties and behavior of materials and the effect of materials on each
                        other....
                    </div>
            ...
            <div className='m-24'>
                <div className='text-4xl font-semibold text-white'>Popular Courses</div>
                <div className='my-20 mx-10 flex justify-between'>
                    <div className="relative flex w-80 flex-col rounded-xl bg-[#43639c] bg-clip-border text-white shadow-md">
            ...
            <div className='m-20 grid grid-cols-2 '>
                ...
                <div>
                    ...
                    <div className='text-slate-300 mr-5 my-6'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi rem quaerat eius maxime quasi expedita fuga minus corporis, temporibus deserunt beatae aperiam vero ad laudantium repudiandae officia ipsam vel excepturi.
                    </div>
                    <ul className='text-white'>
                        <li className='m-2'>Free for physically hsndicraft</li>
                        <li className='m-2'>Easy to use</li>
                        <li className='m-2'>Course certificate for courses</li>
                    </ul>
            ...
            <div className='m-20'>
                <div className='m-10 text-white text-4xl font-bold text-center'>
                    Meet The Team
                </div>
                ...
                <div className='grid grid-cols-2' >
                    <div className=' flex justify-center'>
                            ...
                            <img className="w-28 h-28 bg-blue-700 mt-8 rounded-full border-4 border-[slate-50] z-10 group-hover:scale-150 group-hover:-translate-x-24  group-hover:-translate-y-20 transition-all duration-500" src='https://assets.leetcode.com/users/avatars/avatar_1662445212.png' />
                            <div className="z-10  group-hover:-translate-y-10 transition-all duration-500">
                                <span className="text-2xl font-semibold">Shaurya Gupta </span>
                    ...
                    <div className=' flex justify-center'>
                            ...
                            <div className="group before:hover:scale-95 before:hover:h-72 before:hover:w-80 before:hover:h-44 before:hover:rounded-b-2xl before:transition-all before:duration-500 before:content-[''] before:w-80 before:h-24 before:rounded-t-2xl before:bg-gradient-to-bl from-violet-900 via-indigo-700 to-cyan-700 before:absolute before:top-0 w-80 h-72 relative bg-slate-50 flex flex-col items-center justify-center gap-2 text-center rounded-2xl overflow-hidden">
                                <img className="w-28 h-28 bg-blue-700 mt-8 rounded-full border-4 border-[slate-50] z-10 group-hover:scale-150 group-hover:-translate-x-24  group-hover:-translate-y-20 transition-all duration-500" src={Khagesh} />
                                <div className="z-10  group-hover:-translate-y-10 transition-all duration-500">
                                    <span className="text-2xl font-semibold">Khagesh Sharma </span>
